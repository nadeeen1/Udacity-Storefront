...
describe('Orders endpoint testing', function () {
    ...
    it('creates a new order', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const res = yield request.post('/orders/create')
    ...
    it('returns complete customer orders', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield request.post('/orders/create')
                .set('Authorization', 'Bearer ' + token)
                .send(order1);
            yield request.post('/orders/create')
                .set('Authorization', 'Bearer ' + token)
                .send(order2);
            const res = yield request.get('/orders/complete')
                .set('Authorization', 'Bearer ' + token)
                .send(user);
    ...
    it('returns current user order', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const res = yield request.get('/orders/current')
                .set('Authorization', 'Bearer ' + token)
                .send(user);
            expect(res.status).toEqual(200);
    ...
    it('shouldnt add product to order', function () {
        return __awaiter(this, void 0, void 0, function* () {
            const product = {
                quantity: 20,
                order_id: 1,
            ...
            const res = yield request.post('/orders/1/products')
                .set('Authorization', 'Bearer ' + token)
                .send(product);
